...
We evaluated 35 voyages, 13 on the Indian Ocean route and 22 on the North Atlantic route, spanning the full collection window to date
...
\midrule
Indian Ocean  & 13 & 346.48 [341.6, 351.4] & 352.84 [347.7, 358.1] & 355.07 [349.7, 360.6] & $-1.80$ [$-2.10,-1.50$] & $-2.41$ [$-2.71,-2.12$] & $-0.62$ [$-0.74,-0.51$] \\
North Atlantic & 22 & 196.75 [192.1, 201.8] & 202.01 [197.2, 207.2] & 203.88 [198.9, 209.3] & $-2.60$ [$-2.89,-2.31$] & $-3.48$ [$-3.80,-3.14$] & $-0.91$ [$-1.05,-0.76$] \\
\bottomrule
\end{tabular}
\end{table}
...
on the Indian Ocean route and from 2.30 to 8.12 mt on the North Atlantic route.

\noindent\textbf{The absolute advantage was comparable across routes, but proportionally larger on
the shorter voyage.} The mean saving was similar in absolute terms: 6.36 mt on the Indian Ocean route and 5.27 mt on
the North Atlantic route, even though the North Atlantic route takes roughly half the time. As a fraction of total fuel, the advantage is
...
fuel relative to Naive on the Indian Ocean route and 3.48\% on the North Atlantic route. Luo's saving relative to Naive was smaller,
0.62\% and 0.91\%. This is because Luo can change its speed only once per block, while SR can change
it on every leg.

\noindent\textbf{Departure weather dominated voyage-to-voyage fuel variation.} On the North Atlantic route, under the
...
\midrule
North Atlantic & 12 & $-1.8$ & $0.0$  & 11/12 \\
Indian Ocean   & 7  & $-1.3$ & $-0.0$ & 6/7 \\
\bottomrule
\end{tabular}
\end{table}
...
SR reduced realised fuel relative to set-and-forget on 17 of 19 voyages (mean $-1.8\%$ on the North Atlantic route,
$-1.3\%$ on the Indian Ocean route; best $-3.69\%$). The two exceptions were marginal ($+0.10\%$ on the Indian Ocean route,
$+0.39\%$ on the North Atlantic route), where committing early speeds against forecasts that were later revised cost
...
accuracy degraded systematically with lead time (wind RMSE roughly doubled over 133 h on the Indian Ocean route;
$+286\%$ over 144 h on the North Atlantic route), establishing why realised RH fuel exceeded the oracle. Second, the
6 h re-plan cadence was fixed to the wind model's re-initialisation cycle, of which 86\% of hourly queries returned
...
re-planning is therefore bounded by how much the weather actually varies over a departure's window, largest on variable departures, vanishing or reversing on calm ones. This is best read as a
