...
C^{*}(d,t)=\min_{\substack{(\tilde d,\tilde t) \in\mathcal{A}( d, t)}}   \begin{cases}     \infty & \tilde t =  t_{\Theta} , d < d_M \\
	C^{*}(\tilde d,\tilde t)+(\tilde t- t)\,\phi(d,t; (\tilde d- d)/(\tilde t-t))  & otherwise
\end{cases}		
\end{equation}
With the boundary condition 
$$C^*(0,0) = 0.$$

We deonte the solution of (\ref{eq:cost-to-arrive}) for each  state $(d,t)$ by  $(\tilde d^{\star},\tilde t^{\star})$. The value of this soluton is 
