...
end of this section). \todo{FIG: a single state $(d,t)$, its two walls
$d_{\mathcal{D}(d)}$ and $t_{\mathcal{T}(t)}$, the admissible speed cone $[v_{\min},v_{\max}]$, and
the $\kappa$ candidate grid nodes it selects on the walls --- the two families of Eq.~(5)}
