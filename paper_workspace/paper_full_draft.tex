...
systems that integrate the governing equations of the atmosphere and ocean forward in time from an estimated initial state, and that periodically re-initialise on a fixed cycle.  The system provide the following measurements in spatial granularity of $0.25\degree \times 0.25\degree$ and temporal granularity of 6 hours. At each sampling point the system also provides a forecast for the next 168 hours (a week) in the same granularity. 
