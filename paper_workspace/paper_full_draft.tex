...
speed $L/T \pm 3$ kn (Section~\ref{sec:methods}), and the arrival time $T$ was binding in every run
(zero slack) --- so all comparisons are at equal voyage time, isolating the effect of the setting
rather than the schedule's duration.
