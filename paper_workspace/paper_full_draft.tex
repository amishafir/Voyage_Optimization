...
\caption{One state of the dynamic program and its candidate successors (values illustrative). From
the state $(d,t)$, every admissible speed leads to one of two walls: the next distance line
