...
where the operative data change, each $0.08\degree$ weather-cell crossing and each heading change, rather than being locked across coarse stages. This per-cell resolution, unreachable by stage-based
...
voyage, chosen so that both grids can be read off the axes; $5$ NM is the width of a
$0.08\degree$ cell at the latitudes of the two study routes. Distance increases to the right and time
