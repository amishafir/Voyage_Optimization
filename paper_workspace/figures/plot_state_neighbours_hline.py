"""
Companion to plot_state_neighbours.py: the SAME construction, but the
popped state sits ON A TIME LINE (a horizontal line — a decision epoch),
with its distance coordinate interior to a cell:
